...
public class AsignarBinocularesGuia extends Command {
    private final IdAdministracion idAdministracion;
    private final IdGuia idGuia;
    private final Binoculares binoculares;

    public AsignarBinocularesGuia(IdAdministracion idAdministracion, IdGuia idGuia, Binoculares binoculares) {
